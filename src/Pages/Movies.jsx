...
function Movies() {
  ...
  useEffect(() => {
    axios.get('https://api.themoviedb.org/3/movie/upcoming?api_key=1f698941c0f28691e6c2b132251a83e9')
  ...
  return (
    <div className="container-fluid mt-5 py-5 moviecards">
      <h2 className="text-center my-4 p-2 rounded bg-secondary">Upcoming Movies</h2>
